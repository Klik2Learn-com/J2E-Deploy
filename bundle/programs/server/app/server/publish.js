...
/**
*	@summary: Publishes data from the 'userAudioRecordings' collection. Data should be published in the following way:
...
*/
Meteor.publish("userAudioRecordings", function () {
	if (Roles.userIsInRole(this.userId, 'admin')) {
...
Meteor.publish("assessmentAudioRecordings", function () {
