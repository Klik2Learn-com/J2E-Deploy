(function (global) {
    ...
    function bindEvents(el, scope) {
        ...
        highlightFunction = scope.highlightHandler.bind(scope);
        el.addEventListener('mouseup', highlightFunction);
        el.addEventListener('touchend', highlightFunction);
    }

    function unbindEvents(el, scope) {
        el.removeEventListener('mouseup', highlightFunction);
        el.removeEventListener('touchend', highlightFunction);
    }
    ...
    /**
    *   Used to bind a DOM element to the TextHighlighter
    *   @by James Minney
    */
    TextHighlighter.prototype.binder = function (element, options) {
        this.el = element;
