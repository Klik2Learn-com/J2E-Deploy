Template.Yeti_d4_e4.helpers({
	
	activeSection: function(){
		var activeSection = Session.get("activeSection");
		return (activeSection == "#Yeti_d4_e4");
	}
});


Template.Yeti_d4_e4.events({
	"dragstart .dragitem": function(evt) {
		...
		$.k2l.Yeti_d4_e4.draggedElement = evt.currentTarget;
	},
	...
	"drop .ddtarget": function(evt) {
		...
		if ($($.k2l.Yeti_d4_e4.draggedElement).parent().hasClass('speech1')) {
			$($.k2l.Yeti_d4_e4.draggedElement).html('&nbsp;');
			$($.k2l.Yeti_d4_e4.draggedElement).removeClass('scramble');
			$($.k2l.Yeti_d4_e4.draggedElement).removeClass('dragitem');
			$($.k2l.Yeti_d4_e4.draggedElement).addClass('ddtarget ddwidth4');
			$($.k2l.Yeti_d4_e4.draggedElement).attr('draggable', 'False');
	...
	"click .pagination": function(evt){
		$.k2l.Yeti_d4_e4.draggedElement = {};
	},
	
	"click #submitButton": function(evt){
		var answer = true;
		if ($('#target1').html() != 'Scientists'){
			answer = false;
		}
		if ($('#target2').html() != 'think') {
			answer = false;
		}
		if ($('#target3').html() != 'the bear'){
			answer = false;
		}
		if ($('#target4').html() != 'may still'){
			answer = false;
		}
		if ($('#target5').html() != 'be'){
			answer = false;
		}
		if ($('#target6').html() != 'there.') {
			answer = false;
		}
		...
		if (answer == true) {
			...
			Session.set('d4_e4_result', 'correct');
...
Template.Yeti_d4_e4.rendered = function() {
	
	if(typeof $.k2l == 'undefined'){
		$.k2l = {};
	};
	
	if (typeof $.k2l.Yeti_d4_e4 == 'undefined') {
		$.k2l.Yeti_d4_e4 = {};
	};
