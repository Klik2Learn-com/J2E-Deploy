Template.Yeti_d2_e2.helpers({
	
	activeSection: function(){
		var activeSection = Session.get("activeSection");
		return (activeSection == "#Yeti_d2_e2");
	}
});


Template.Yeti_d2_e2.events({
	"dragstart .dragitem": function(evt) {
		...
		$.k2l.Yeti_d2_e2.draggedElement = evt.currentTarget;
	},
	...
	"drop .answerSlot": function(evt) {
		...
		if ($($.k2l.Yeti_d2_e2.draggedElement).parent().hasClass('Yetibox')) {
			$($.k2l.Yeti_d2_e2.draggedElement).addClass('answerBank');
			$($.k2l.Yeti_d2_e2.draggedElement).addClass('ddtarget');
			//$($.k2l.Yeti_d2_e2.draggedElement).addClass('ddwidth4');
			$($.k2l.Yeti_d2_e2.draggedElement).removeClass('ddsourceyeti');
			$($.k2l.Yeti_d2_e2.draggedElement).html('&nbsp;');
			$($.k2l.Yeti_d2_e2.draggedElement).attr('draggable', 'False');
		} else {
			// Otherwise it must be dragged from an answerSlot
			$($.k2l.Yeti_d2_e2.draggedElement).parent().removeClass('yetidd');
			$($.k2l.Yeti_d2_e2.draggedElement).parent().addClass('ddtarget');
			//$($.k2l.Yeti_d2_e2.draggedElement).parent().removeClass('ddwidth6'); // swap ddwidth6 for 7
			$($.k2l.Yeti_d2_e2.draggedElement).parent().addClass('ddwidth4');
			$($.k2l.Yeti_d2_e2.draggedElement).parent().html('&nbsp;');
		}
	...
	"drop .answerBank": function(evt) {
		...
		if ($($.k2l.Yeti_d2_e2.draggedElement).parent().hasClass('answerSlot')) {
			$($.k2l.Yeti_d2_e2.draggedElement).parent().removeClass('yetidd');
			$($.k2l.Yeti_d2_e2.draggedElement).parent().addClass('ddtarget');
			//$($.k2l.Yeti_d2_e2.draggedElement).parent().removeClass('ddwidth6'); // swap ddwidth6 for 7
			$($.k2l.Yeti_d2_e2.draggedElement).parent().addClass('ddwidth4');
	...
	"click #submitButton": function(evt){
		...
		if ($('#target1').children().html() != 'like'){
			answer = false;
		} else {
			score++;
		}
		if ($('#target2').children().html() != 'for') {
			answer = false;
		} else{
			score++;
		}
		if ($('#target3').children().html() != 'around'){
			answer = false;
		} else {
			score++;
		}
		...
		if (answer == true) {
			Session.set('d2_e2_result', 'correct');
...
Template.Yeti_d2_e2.rendered = function() {
	
	if(typeof $.k2l == 'undefined'){
		$.k2l = {};
	};
	
	if (typeof $.k2l.Yeti_d2_e2 == 'undefined') {
		$.k2l.Yeti_d2_e2 = {};
	};
