Template.Yeti_d3_h3.helpers({
	
	activeSection: function(){
		var activeSection = Session.get("activeSection");
		return (activeSection == "#Yeti_d3_h3");
	}
});

Template.Yeti_d3_h3.events({
	
	"click .yetibuttonaudio": function(evt) {
		var soundfile = "Yeti/" + $(evt.currentTarget).attr('id') + ".m4a";
		$.k2l.Yeti_d3_h3.sound.src = soundfile;
		$.k2l.Yeti_d3_h3.sound.play();
	},
	
	"click .button1": function(evt){
		$(evt.currentTarget).next('div').css('visibility', 'visible');
		if ($(evt.currentTarget).attr('id') == "answerButton1"){
		...
		setTimeout(function () {
			...
			$.k2l.Yeti_d3_h3.sound.pause();
			$.k2l.Yeti_d3_h3.sound.src = "";
		}, 2000);
	}
...
Template.Yeti_d3_h3.rendered = function() {
	
	if(typeof $.k2l == 'undefined'){
		$.k2l = {};
	}
	if (typeof $.k2l.Yeti_d3_h3 == 'undefined') {
		$.k2l.Yeti_d3_h3 = {};
	};
	
	$.k2l.Yeti_d3_h3.sound = new Audio();
