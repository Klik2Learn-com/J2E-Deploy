Template.m3Game_Score.helpers({
	activeSection: function () {
		var activeSection = Session.get("activeSection");
		return (activeSection == "#m3Game_Score")
	},
	...
	excellentScore: function () {
		...
		var Easy_Correct = Session.get('Easy_Correct');
		if (Easy_Correct > 20 && Easy_Correct < 26 || Easy_Correct == 20) {
			return true;
		} else {
			return false;
		}
	...
	goodScore: function () {
		...
		if (path == true) {
			var Easy_Correct = Session.get('Easy_Correct');
			if (Easy_Correct > 13 && Easy_Correct < 20 || Easy_Correct == 13) {
				return true;
			} else {
				return false;
			}
	...
	okayScore: function () {
		...
		if (path == true) {
			var Easy_Correct = Session.get('Easy_Correct');
			if (Easy_Correct > 7 && Easy_Correct < 13) {
				return true;
			} else {
				return false;
			}
