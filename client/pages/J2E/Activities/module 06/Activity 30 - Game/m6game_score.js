Template.m6Game_Score.helpers({
	activeSection: function () {
		var activeSection = Session.get("activeSection");
		return (activeSection == "#m6Game_Score")
	},
	...
	excellentScore: function () {
		...
		var Easy_Correct = Session.get('Easy_Correct');
		if (Easy_Correct > 21 && Easy_Correct < 27 || Easy_Correct == 21) {
			return true;
		} else {
			return false;
		}
	...
	goodScore: function () {
		...
		if (path == true) {
			var Easy_Correct = Session.get('Easy_Correct');
			if (Easy_Correct > 14 && Easy_Correct < 21 || Easy_Correct == 14) {
				return true;
			} else {
				return false;
			}
	...
	okayScore: function () {
		...
		if (path == true) {
			var Easy_Correct = Session.get('Easy_Correct');
			if (Easy_Correct > 7 && Easy_Correct < 14) {
				return true;
			} else {
				return false;
			}
	...
	percentage: function () {
		...
		var percentage = Math.round(correctScore / 27 * 100);
