Template.m7Game_Score.helpers({
	activeSection: function () {
		var activeSection = Session.get("activeSection");
		return (activeSection == "#m7Game_Score")
	},
	...
	excellentScore: function () {
		...
		var Easy_Correct = Session.get('Easy_Correct');
		if (Easy_Correct > 22 && Easy_Correct < 29 || Easy_Correct == 22) {
			return true;
		} else {
			return false;
		}
	...
	goodScore: function () {
		...
		if (path == true) {
			var Easy_Correct = Session.get('Easy_Correct');
			if (Easy_Correct > 15 && Easy_Correct < 22 || Easy_Correct == 15) {
				return true;
			} else {
				return false;
			}
	...
	percentage: function () {
		...
		var percentage = Math.round(correctScore / 29 * 100);
