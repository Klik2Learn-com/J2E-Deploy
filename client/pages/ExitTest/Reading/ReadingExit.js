Template.InitialReadingExit.helpers({ 
...
Template.InitialReadingExit.events({
...
Template.InitialReadingExit.created = function() {
	Template.instance().assessmentId = Router.current().params.assessmentid;
}

Template.InitialReadingExit.destroyed = function() {
