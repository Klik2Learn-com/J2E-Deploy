Template.C1l.helpers({
    
    activeSection: function() {
        var activeSection = Session.get("activeSection");
        return (activeSection == "#C1l");
    },
...
Template.C1l.created = function() {
    ...
    Template.instance().audio.src = "/audio/initial/conversations/c1.m4a";
};

Template.C1l.destroyed = function() {
    Template.instance().audio.pause();
    Template.instance().audio = {};
}

Template.C1l.rendered = function(){
    window.scrollTo(0, 0);
